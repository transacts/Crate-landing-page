  ...
  },
  {
    ...
    background: (
      <div className="absolute inset-0 flex items-center justify-center gap-4">
        {/* ChatGPT Logo Square */}
        <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center shadow-lg border border-white/20 backdrop-blur-sm">
        ...
        {/* Claude Logo Square */}
        <div className="w-16 h-16 bg-gradient-to-br from-orange-400 to-red-500 rounded-2xl flex items-center justify-center shadow-lg border border-white/20 backdrop-blur-sm">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-white">
            <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22C6.486 22 2 17.514 2 12S6.486 2 12 2s10 4.486 10 10-4.486 10-10 10z" fill="currentColor"/>
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-2">
        <div className="flex flex-col lg:flex-row gap-4 h-auto lg:h-[36rem]">
          {/* Left column - Integrations card (30% width) */}
          <div className="w-full lg:w-[30%]">
            <BentoCard {...crateFeatures[0]} className="h-full" />
          </div>
          ...
          <div className="w-full lg:w-[70%] flex flex-col gap-4">
            ...
            <div className="flex gap-4 flex-1">
              <div className="flex-1">
                <BentoCard {...crateFeatures[1]} className="h-full" />
              </div>
              <div className="flex-1">
                <BentoCard {...crateFeatures[2]} className="h-full" />
              </div>
            </div>
            ...
            <div className="flex gap-4 flex-1">
              <div className="flex-1">
                <BentoCard {...crateFeatures[3]} className="h-full" />
              </div>
              <div className="flex-1">
                <BentoCard {...crateFeatures[4]} className="h-full" />
              </div>
            </div>
          </div>
        </div>
